...
class PlayScene extends Phaser.Scene {
    ...
    initStartTrigger() {
        ...
        this.physics.add.overlap(this.startTrigger, this.dino, () => {
            ...
            const startEvent = this.time.addEvent({
                ...
                callbackScope: this,
                callback: () => {
                    this.dino.setVelocityX(80);// 80 pixels
                    ...
                    if (this.ground.width >= 1000) {
                        ...
                        this.dino.setVelocityX(0);// it's not running any longer
    ...
    handleInputs() {
        ...
        this.input.keyboard.on('keyup_DOWN', () => {
            // if dino's not touching the floor dont provide velocity
    ...
    update(time, delta) {
        ...
        if (this.dino.body.deltaAbsY() > 0) {
            ...
            this.dino.setTexture('dino', 0); // set the image that it's no moving
        } else {
            // if dino's height is less than 58 - insert this image else other image
